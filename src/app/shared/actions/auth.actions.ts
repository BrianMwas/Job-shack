...
export const loggedInUserLoad = createAction(AuthActionTypes.LOAD_USER);
export const loggedInUser = createAction(AuthActionTypes.LOAD_USER_SUCCESS, props<{user: User}>());
export const loggedInUserFail = createAction(AuthActionTypes.LOAD_USER_FAILURE, (errorMessage: 'Error loading user') => ({ payload: { errorMessage }}))

export const userProfileLoad = createAction(AuthActionTypes.LOAD_USER_PROFILE);
